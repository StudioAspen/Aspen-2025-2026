...
namespace uPalette.Editor.Foundation
{
    ...
    {
        public static IObservable<TreeViewItem<int>> OnItemAddedAsObservable(this TreeViewBase self)
        {
            return new AnonymousObservable<TreeViewItem<int>>(observer =>
            {
                void OnNext(TreeViewItem<int> item)
                {
                    try
                    {
        ...
        public static IObservable<TreeViewItem<int>> OnItemRemovedAsObservable(this TreeViewBase self)
        {
            return new AnonymousObservable<TreeViewItem<int>>(observer =>
            {
                void OnNext(TreeViewItem<int> item)
