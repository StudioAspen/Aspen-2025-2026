...
namespace uPalette.Editor.Core.ThemeEditor
{
    internal class ThemeEditorTreeView : TreeViewBase
    {
        ...
        public ThemeEditorTreeView(TreeViewState<int> state) : base(state)
        {
        ...
        protected override IOrderedEnumerable<TreeViewItem<int>> OrderItems(IList<TreeViewItem<int>> items, int keyColumnIndex,
            bool ascending)
        {
