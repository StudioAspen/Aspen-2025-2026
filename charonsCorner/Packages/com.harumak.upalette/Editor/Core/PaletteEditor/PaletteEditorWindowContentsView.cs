...
namespace uPalette.Editor.Core.PaletteEditor
{
    ...
    {
        [SerializeField] private TreeViewState<int> _state = new TreeViewState<int>();
        ...
        protected abstract PaletteEditorTreeView<T> CreateTreeView(TreeViewState<int> state);
    }
}
