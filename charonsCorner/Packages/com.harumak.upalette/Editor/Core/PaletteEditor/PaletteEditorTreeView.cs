...
namespace uPalette.Editor.Core.PaletteEditor
{
    internal abstract class PaletteEditorTreeView<T> : TreeViewBase
    {
        ...
        protected PaletteEditorTreeView(TreeViewState<int> state) : base(state)
        {
        ...
        private void RemoveParentItemsIfEmpty(TreeViewItem<int> item)
        {
        ...
        protected override IOrderedEnumerable<TreeViewItem<int>> OrderItems(
            IList<TreeViewItem<int>> items,
            int keyColumnIndex,
            bool ascending
        )
        {
            string KeySelector(TreeViewItem<int> x)
            {
        ...
        protected override string GetTextForSearch(TreeViewItem<int> item, int columnIndex)
        {
        ...
        public void SetItemIndexByName(TreeViewItem<int> item)
        {
        ...
        public void OrderItemsByName(TreeViewItem<int> parent, bool recursive)
        {
