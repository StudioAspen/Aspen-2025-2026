...
from aspen.blender.common.export_manager import api # This allows this file to access the functions from the API script.
                                                    # Essentially, they're linked now.
...
from aspen.core.telemetry.loggers import get_blender_logger # used for Mikyle's telemetry service.
